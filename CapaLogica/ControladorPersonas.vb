...
Public Module ControladorPersonas
    ...
    Public Sub ModificarPersona(Id As String, nombre As String, apellido As String, mail As String, fechaHoraCreacion As String, activo As Boolean, telefono1 As String, telefono2 As String)
        'Guarda los datos de Persona 
        Dim p As New ModeloPersona
        p.id = Id
        p.nombre = nombre
